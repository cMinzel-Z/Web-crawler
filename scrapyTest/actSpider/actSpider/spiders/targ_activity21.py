...
class ActivitySpider21(CrawlSpider):
    name = "act21"
    allowed_domains = ["triperformancelab.co.uk"]
    start_urls = ["http://www.triperformancelab.co.uk/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_21.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider21)
process.start()

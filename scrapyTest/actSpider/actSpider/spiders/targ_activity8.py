...
class ActivitySpider8(CrawlSpider):
    name = "act8"
    allowed_domains = ["freedom-leisure.co.uk"]
    start_urls = ["https://www.freedom-leisure.co.uk/centres/llandrindod-wells-sports-centre"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_8.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider8)
process.start()

...
class ActivitySpider27(CrawlSpider):
    name = "act27"
    allowed_domains = ["crownfitnessclub.co.uk"]
    start_urls = ["http://www.crownfitnessclub.co.uk/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_27.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider27)
process.start()

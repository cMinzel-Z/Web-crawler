...
class ActivitySpider1(CrawlSpider):
    name = "act1"
    allowed_domains = ["freedom-leisure.co.uk"]
    start_urls = ["https://www.freedom-leisure.co.uk/centres/rhayader-leisure-centre"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_1.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider1)
process.start()

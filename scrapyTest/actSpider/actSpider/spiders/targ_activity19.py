...
class ActivitySpider19(CrawlSpider):
    name = "act19"
    allowed_domains = ["jmcompletefitness.co.uk"]
    start_urls = ["http://www.jmcompletefitness.co.uk/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_19.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider19)
process.start()

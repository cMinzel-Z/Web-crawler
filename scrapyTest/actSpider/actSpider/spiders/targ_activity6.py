...
class ActivitySpider6(CrawlSpider):
    name = "act6"
    allowed_domains = ["actif.wales"]
    start_urls = ["https://www.actif.wales/locations/amman-valley/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_6.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider6)
process.start()

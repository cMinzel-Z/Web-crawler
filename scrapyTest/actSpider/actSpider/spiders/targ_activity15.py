...
class ActivitySpider15(CrawlSpider):
    name = "act15"
    allowed_domains = ["monmouthshire.gov.uk"]
    start_urls = ["http://www.monmouthshire.gov.uk/things-to-do/monleisure/abergavenny-leisure-centre"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_15.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider15)
process.start()

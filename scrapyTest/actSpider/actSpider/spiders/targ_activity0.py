...
class ActivitySpider0(CrawlSpider):
    name = "act0"
    allowed_domains = ["tregaronleisurecentre.co.uk"]
    start_urls = ["https://tregaronleisurecentre.co.uk/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_0.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider0)
process.start()

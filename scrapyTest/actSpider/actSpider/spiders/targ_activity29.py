...
class ActivitySpider29(CrawlSpider):
    name = "act29"
    allowed_domains = ["tptspersonaltraining.co.uk"]
    start_urls = ["https://tptspersonaltraining.co.uk/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_29.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider29)
process.start()

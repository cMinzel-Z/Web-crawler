...
class ActivitySpider18(CrawlSpider):
    name = "act18"
    allowed_domains = ["freedom-leisure.co.uk"]
    start_urls = ["https://www.freedom-leisure.co.uk/centres/maldwyn-leisure-centre/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_18.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider18)
process.start()

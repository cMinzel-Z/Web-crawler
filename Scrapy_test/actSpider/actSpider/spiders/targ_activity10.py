...
class ActivitySpider10(CrawlSpider):
    name = "act10"
    allowed_domains = ["ceredigionactif.org.uk"]
    start_urls = ["http://www.ceredigionactif.org.uk/cardigan.html"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_10.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider10)
process.start()

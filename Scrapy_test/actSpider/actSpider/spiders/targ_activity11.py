...
class ActivitySpider11(CrawlSpider):
    name = "act11"
    allowed_domains = ["freedom-leisure.co.uk"]
    start_urls = ["https://www.freedom-leisure.co.uk/centres/penyrheol-leisure-centre/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_11.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider11)
process.start()

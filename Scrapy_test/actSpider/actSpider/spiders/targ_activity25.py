...
class ActivitySpider25(CrawlSpider):
    name = "act25"
    allowed_domains = ["valleyspainreliefclinic.co.uk"]
    start_urls = ["http://www.valleyspainreliefclinic.co.uk/contact-us/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_25.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider25)
process.start()

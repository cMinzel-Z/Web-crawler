...
class ActivitySpider16(CrawlSpider):
    name = "act16"
    allowed_domains = ["freedom-leisure.co.uk"]
    start_urls = ["https://www.freedom-leisure.co.uk/centres/ystradgynlais-sports-centre"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_16.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider16)
process.start()

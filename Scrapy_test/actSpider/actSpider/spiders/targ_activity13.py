...
class ActivitySpider13(CrawlSpider):
    name = "act13"
    allowed_domains = ["ceredigionactif.org.uk"]
    start_urls = ["http://www.ceredigionactif.org.uk/lampeter.html"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_13.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider13)
process.start()

...
class ActivitySpider22(CrawlSpider):
    name = "act22"
    allowed_domains = ["rdhealthandfitness.com"]
    start_urls = ["http://www.rdhealthandfitness.com/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_22.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider22)
process.start()

...
class ActivitySpider5(CrawlSpider):
    name = "act5"
    allowed_domains = ["freedom-leisure.co.uk"]
    start_urls = ["https://www.freedom-leisure.co.uk/centres/builth-wells-sports-centre-and-swimming-pool/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_5.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider5)
process.start()

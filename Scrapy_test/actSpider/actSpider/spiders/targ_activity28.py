...
class ActivitySpider28(CrawlSpider):
    name = "act28"
    allowed_domains = ["killayhealthandfitnessclub.co.uk"]
    start_urls = ["http://www.killayhealthandfitnessclub.co.uk/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_28.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider28)
process.start()

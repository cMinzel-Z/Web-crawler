...
class ActivitySpider24(CrawlSpider):
    name = "act24"
    allowed_domains = ["shapesgym.co.uk"]
    start_urls = ["http://www.shapesgym.co.uk/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_24.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider24)
process.start()

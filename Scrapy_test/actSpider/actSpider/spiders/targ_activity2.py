...
class ActivitySpider2(CrawlSpider):
    name = "act2"
    allowed_domains = ["powys.gov.uk"]
    start_urls = ["http://brecon-leisurecentre.powys.gov.uk/"]
    rules = (
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "data/items_2.json": {"format": "json"},
    },
})

process.crawl(ActivitySpider2)
process.start()
